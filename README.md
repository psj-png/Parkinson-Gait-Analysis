...
> `data/02_Abnormal` 32개 영상 전체 진단 (`04_diagnosis.py`)
> 결과 저장: `output/results/diagnosis_abnormal_full.json`

| 항목 | 값 |
|------|-----|
| 테스트 영상 수 | 32개 |
| 정확 (Abnormal 예측) | **30개 (93.8%)** |
| 오분류 (Normal 예측) | 2개 (6.2%) |
| 오분류 영상 | `A06_Abn_S_01.mp4`, `A15_Abn_B_01.mp4` |
